...
This repository contains the source code for the user management application built using Python Flask. The app allows users to create, distribute, and analyze surveys easily. It is designed to be scalable and user-friendly, offering a seamless experience for survey creators and respondents alike.
Features
